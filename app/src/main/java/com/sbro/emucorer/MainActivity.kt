...
import com.sbro.emucorer.core.AppLocaleManager
import com.sbro.emucorer.core.GamepadManager
import com.sbro.emucorer.core.NativeApp
import com.sbro.emucorer.core.PlayInAppReviewManager
...
import com.sbro.emucorer.navigation.AppNavigation
import com.sbro.emucorer.ui.common.GamepadUiInputRouter
import com.sbro.emucorer.ui.theme.EmuCoreRTheme
...
open class MainActivity : ComponentActivity() {
    ...
    private fun recordCompletedEmulationSession(
        ...
        val app = application as EmuCoreRApp
        ...
        PlayInAppReviewManager.request(this) { result ->
            ...
            when (result) {
                PlayInAppReviewManager.Result.COMPLETED -> {
                    (application as EmuCoreRApp).applicationScope.launch {
