...
import com.sbro.emucorer.MainActivity
import com.sbro.emucorer.R
import com.sbro.emucorer.data.GameItem

object GameLaunchShortcut {
    const val ACTION_LAUNCH_GAME = "com.sbro.emucorer.action.LAUNCH_GAME"
    const val EXTRA_GAME_PATH = "com.sbro.emucorer.extra.GAME_PATH"
    const val EXTRA_SAVE_SLOT = "com.sbro.emucorer.extra.SAVE_SLOT"
