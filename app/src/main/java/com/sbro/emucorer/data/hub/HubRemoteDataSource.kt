package com.sbro.emucorer.data.hub
...
class HubRemoteDataSource(context: Context) {
    ...
    private fun fetchBytes(rawUrl: String, maxBytes: Long): ByteArray {
        ...
        repeat(MAX_REDIRECTS + 1) {
            ...
            val connection = (next.openConnection() as HttpURLConnection).apply {
                ...
                setRequestProperty("User-Agent", "EmuCoreR-Hub/${BuildConfig.VERSION_NAME}")
            }
            try {
    ...
    companion object {
        ...
        // EmuCoreR implements that contract independently of its Android package version.
