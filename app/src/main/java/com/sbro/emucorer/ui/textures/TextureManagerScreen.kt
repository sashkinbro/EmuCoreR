...
import com.sbro.emucorer.data.TexturePackInfo
import com.sbro.emucorer.data.TexturePackRepository
import com.sbro.emucorer.data.TexturePackSummary
            ...
            val result = try {
                withContext(Dispatchers.IO) {
                    runCatching { repository.importPackZip(uri) }
                        .getOrElse { com.sbro.emucorer.data.TextureImportResult(success = false) }
                }
            } finally {
                isWorking = false
            }
