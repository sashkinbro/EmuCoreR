package com.sbro.emucorer.ui.formats
...
import com.sbro.emucorer.core.ImageConversionManager
        ...
        Column(
            ...
            Column(
                ...
                FormatGroupCard(
                    ...
                    title = stringResource(R.string.formats_ps1_supported_title),
                    body = stringResource(R.string.formats_ps1_supported_body),
                    formats = ImageConversionManager.libraryFormats
                )

                FormatGroupCard(
                    icon = Icons.Rounded.Memory,
                    title = stringResource(R.string.formats_ps1_recommended_title),
                    body = stringResource(R.string.formats_ps1_recommended_body),
                    formats = ImageConversionManager.recommendedFormats
                )

                FormatGroupCard(
                    icon = Icons.Rounded.FolderZip,
                    title = stringResource(R.string.formats_ps1_planned_title),
                    body = stringResource(R.string.formats_ps1_planned_body),
                    formats = listOf("M3U")
                )
            }
        }
